                ...
                <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center h-16">
                        ...
                        <div className="hidden md:flex items-center gap-8">
                            <a href="/login" className="text-sm text-blue-600 hover:text-blue-700 font-medium transition-colors">Đăng nhập</a>
                            <a href="/register" className="bg-blue-600 text-white text-sm px-5 py-2.5 rounded-md hover:bg-blue-700 transition-colors font-medium inline-block">Tạo CV của tôi</a>
                        </div>
                    </div>
                </nav>
            </header>
...
// ===================================================================
// Giao diện cho người dùng đã đăng nhập - QUẢN LÝ CV
// ===================================================================
const LoggedInView = () => {
        ...
        <div className="bg-gray-100 min-h-screen">
            <nav className="bg-white shadow-md">
                <div className="container mx-auto px-6 py-3 flex justify-between items-center">
                    <a href="/" className="text-xl font-bold text-gray-800">CV Builder</a>
                    <button onClick={handleLogout} className="bg-red-500 text-white px-4 py-2 rounded-lg hover:bg-red-600 font-semibold">
                        Đăng xuất
                    </button>
                </div>
            </nav>
...
export default function Dashboard() {
    ...
    return (
        <>
            {isLoggedIn ? <LoggedInView /> : <LandingPageView />}
        </>
    );
}